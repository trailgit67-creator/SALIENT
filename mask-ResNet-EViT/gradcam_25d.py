...
Usage (example):
  ...
  python gradcam_25d.py \
      --checkpoint /home/li46460/TRAIL_Yifan/ConvNeXt-V2/25d_wdm_2.0_225_0.5/baseline_best_s2p00_tp0p050.pt \
      --positives_root /home/li46460/TRAIL_Yifan/MH_225 \
      --negatives_root /home/li46460/TRAIL_Yifan/negative_control_v2_225 \
      --image_size 224 \
      --use_neighbors \
      --num_examples 10 \
      --out_dir ./eigen_cam_vis_3.0
"""
...
def overlay_and_save(
    ...
    # draw mask boundary
    try:
        plt.contour(mask_np, levels=[0.5], colors="lime", linewidths=1.0)
    except Exception:
        pass
    plt.tight_layout()
