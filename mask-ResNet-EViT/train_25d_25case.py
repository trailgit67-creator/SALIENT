...
# 61 62 63 64 65  """.split())
FIXED_TRAIN_POS_SUBJECTS = set("""
1003 1119 1206 1231 1348 1530 1590 1690 1757 1799 1930 2000 2109 2189 2418 2552 2632 2689 2810 3118 3345 365 3840 4175 4268""".split())
...
def main():
    ...
    parser.add_argument("--result_dir", type=str, default="./liver_25case")
    ...
    # In train_25d.py argparse section:
    # parser.add_argument("--preload", action="store_true",
    #                 help="Preload all images into RAM (requires ~40-50GB, eliminates I/O bottleneck)")
    ...
    n_pos_real = sum(1 for it in pos_train_all_items if "J3_M4" not in str(it.path_ct))
    n_pos_syn  = sum(1 for it in pos_train_all_items if "J3_M4" in str(it.path_ct))
